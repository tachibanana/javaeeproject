		...
		<ul>
            ...
            <form class="navbar-form navbar-right" role="search">
                <div class="input-group col-xs-3" >		
						...
						<input type="text" class="form-control-md" name="x" placeholder="Search Forum" style="height:35px;padding-left:5px;" >
...
<div class="container" style="padding-top:100px;">
    ...
    <div class="panel panel-default">
        <div class="panel-heading" style="padding:20px;">		
			...
			<% if(currentUser == null){ %>				
				<button type="button" class="btn btn-info btn-sm pull-right"><a onclick="alert('Please sign in to add a topic.');">Create Thread</a></button>
			<%}else{ %>
			<button type="button" class="btn btn-info btn-sm pull-right"><a href="forum-forum-create.jsp?category_id=<%= categoryId %>&user_id=<%= currentUser.getId()%>">Create Thread</a>
		<%}%>
        </div>
