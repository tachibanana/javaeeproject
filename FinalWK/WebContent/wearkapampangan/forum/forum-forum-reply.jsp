...
<div class="container" style="padding-top:100px;">
	<div class="row">
		<ul class="breadcrumb">
			<li class="completed"><a href="Thread_table.html">Category</a></li>
			<li class="active"><a href="post_thread.html">Title</a></li>
			<li><a href="thread_list.html">Thread</a></li>
			<li><a href="post_reply.html">Reply</a></li>
		</ul>
	</div>
</div>
<div class="container">
                    ...
                    <li class="list-group-item">
                        <div class="row">
                            ...
                            <div class="col-xs-10 col-md-11">
                                <div>
                                    <a href="#">
                                        <%= manager.getTopicByCategoryidAndUserIdAndId(topicId).getSubject() %></a>
                                    <div class="mic-info">
                                        By: <a href="#"><%= manager.getUserById(manager.getTopicByCategoryidAndUserIdAndId(topicId).getUserId()).getFirstName() %></a> on <%= manager.getTopicByCategoryidAndUserIdAndId(topicId).getDate() %>
                                    </div>
                                </div>
                                <!--  
                                <div class="comment-text">
                                    Please write your answer on the textarea
                                </div>
                               -->
                        ...
                        <div>
                            <fieldset style="padding:20px;">
								<!-- <div class="input-group">
									...
									<input id="apikey" name="" class="form-control" placeholder="Subject/Titles" type="text">
								</div> -->
								<br/>
                                <div class="form-group">
									<textarea id="content" class="form-control" rows="3" placeholder="Write your reply" autofocus="" style="height:300px; resize:none;"></textarea>
                                </div>
                                
                            
							<button class="btn btn-success" id="reply-button" >Submit Reply</button>
							<button class="btn btn-default"id="preview-button" >Preview Post</button>
                            </fieldset>
                        </div>
                    </div>
                        </div>
...
$("#preview-button").click(function(){
	var topicId = $("#topic_id").html();
	window.location.href = "/FinalWK/wearkapampangan/forum/forum-forum-post.jsp?topic_id=" + topicId;
});
</script>
<script>
