...
<div class="container">
    <div class="row">       
                        ...
                        <div>
                            <fieldset style="padding:20px;">
								<div class="input-group">
									...
									<input id="apikey1" name="" class="form-control" placeholder="Subject/Titles" type="text">
								</div>
								<br/>
                                <div class="form-group">
									<textarea id="apikey2" class="form-control" rows="3" placeholder="Write your reply" autofocus="" style="height:300px; resize:none;"></textarea>
                                </div>
								<div class="input-group">
									<label>Tags:</label>
									<input id="apikey3" name="" class="form-control" placeholder="Separated by comma" type="text">
								</div>
								<br/>
                                
                            
							<button id = "submit" type="submit" class="[ btn btn-success ]" data-loading-text="Loading..." style="padding:10px;">Submit </button>
							<button id = "cancel" type="submit" class="[ btn btn-default ]" data-loading-text="Loading..." style="padding:10px;">Cancel</button>
                            </fieldset>
                        </div>
                    </div>
                        </div>
        ...
        $("#submit").click(function(){
    		var subject = $("#apikey1").val().trim();
    		var tags = $("#apikey3").val().trim();
    		var content = $("#apikey2").val().trim();
    		var userId = $("#user_id").html().trim();
    		var categoryId = $("#category_id").html().trim();
    		if(content && userId && categoryId){
    			...
    			alert("Something wrong on your query.");
    		}
    	});
