...
@WebServlet("/deliver/mail")
public class DeliveringEmailServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		try{
			...
			message = "<div class='container'><ul style='list-style-type: none; margin: 0;padding: 0;overflow: hidden;background-color: #1ED760; height:100%;'>" +
					...
					+ " <h2>Hello "+ user.getFirstName()  +"</h2><h3>Delivered Message</h3><p>Order : <u>#"+ orderNo +"</u></p><p>We would like to know you that your order will be delivered on you as soon as possible thank you.</p><h4>Wear Kapampangan Team</p>"
			...
			response.sendRedirect("/FinalWK/update/order/status?order_no="+ orderNo +"&status=1");
